    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gdcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gdcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gdcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gdcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GDCOIN, 0.1 GDCOIN, 1 GDCOIN and 10 GDCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gdcoins.atlassian.net/wiki/display/DOC/PrivateSend\">https://gdcoins.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gdcoin Core is shutting down...") + "<br /><br />" +
