    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GDCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("GDCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GDCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GDCOIN-traditional"), QVariant("trad"));
