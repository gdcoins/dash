    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gdcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gdcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gdcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gdcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gdcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gdcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gdcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gdcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a gdcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gdcoin Core help message to get a list with possible Gdcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gdcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gdcoin network", "", count));
}
...
{
    QString strTitle = tr("Gdcoin Core"); // default title
