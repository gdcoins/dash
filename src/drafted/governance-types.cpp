...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GdcoinNetwork") type = GdcoinNetwork;
    if(strType == "GdcoinNetworkVariable") type = GdcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GdcoinNetwork) s = "GdcoinNetwork";
    if(type == GdcoinNetworkVariable) s = "GdcoinNetworkVariable";
