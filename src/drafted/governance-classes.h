 ...
 *
 *   // network
 *   CGdcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.gdcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGdcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: GdcoinNetwork
// //   -- signature requirements : Key1(User)
// class CGdcoinNetworkVariable : public CGovernanceObject
// {
// private:
