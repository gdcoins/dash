...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gdcoin Core gdcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gdcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gdcoin transaction") + "\n" +
              "  gdcoin-tx [options] -create [commands]   " + _("Create hex-encoded gdcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gdcoin transaction
