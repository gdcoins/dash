...
{
    if(fLiteMode) return; // ignore all Gdcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Gdcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("gdcoin-privatesend");
