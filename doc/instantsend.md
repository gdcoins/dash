...
This mechanism has been integrated into Bitcore-Node-Gdcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gdcoins/insight-api-gdcoin#web-socket-api](https://github.com/gdcoins/insight-api-gdcoin#web-socket-api) 
* API: [https://github.com/gdcoins/insight-api-gdcoin#instantsend-transactions](https://github.com/gdcoins/insight-api-gdcoin#instantsend-transactions) 
...
By default, the Gdcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gdcoin Core daemon:
