...
Only requiring some minor changes is gdcoin.cpp.
...
Changes to gdcoin.cpp
----------------------
gdcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
